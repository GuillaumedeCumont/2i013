...
# -*- coding: utf-8 -*-
"""
Created on Mon Feb 11 12:59:52 2019
...
class GoalSearch(object):
    def __init__(self, strategy1, params, strategy2 = None, simu=None, trials=20, max_steps =10000 , max_round_step =40):
...
# Set the current value for the current parameters
        for key, value in self.cur_param.items(): 
            setattr(self.strategy1, key, value)
